...
class RestAPI {
  Future checkInternetConnection() async {
    try {
      final result = await InternetAddress.lookup(ServerAddress.serverAddress);
  ...
  String imageApi(String imageName,
    ...
    var folder = imageFolder == ImageFolder.PROFILE
        ...
        : imageFolder == ImageFolder.TOL
            ? 'products'
            : "documents";
    return "${ServerAddress.serverAddress}/$conversion/$folder/$imageName/${imageSize > 0 ? imageSize : ''}";
  }
}
